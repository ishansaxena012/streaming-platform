...
export function NetworkErrorState({ onRetry, message = "Server communications disrupted" }: NetworkErrorStateProps) {
  return (
    <div className="flex flex-col items-center justify-center p-8 rounded-xl glass-panel border border-white/5 max-w-sm mx-auto text-center space-y-5">
      ...
      <div className="space-y-1.5">
        <h4 className="font-bold text-white text-sm">Connection Disrupted</h4>
        <p className="text-xs text-cinema-gray leading-relaxed">
          {message}. Verify local proxies or double-check internet signals.
        </p>
      </div>
